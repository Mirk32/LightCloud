...
ActiveRecord::Schema.define(version: 20160830165253) do
  ...
  add_index "message_hierarchies", ["ancestor_id", "descendant_id", "generations"], name: "message_anc_desc_udx", unique: true, using: :btree
